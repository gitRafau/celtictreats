...
<html lang="">
	...
	<body>
		...
		<div class="row">
			...
			<nav class="col-md-9 col-md-offset-1 col-lg-9 col-lg-offset-1" style="background-color: red; height: 20px;">
				...
				<button class="btn btn-defaut phone" style="margin-top: 1em;">
					<img src="<?php echo get_theme_file_uri('img/phone_icon.png'); ?>" height="21" class="pull-left">Order Now +353 (0) 087 395 60 20
				</button>-->
			</nav>
	</div>
</main>